    ...
    <body>
            ...
            <tbody>
                <c:forEach var="customer" items="${customers}">
                    <tr>
                        ...
                        <td>${customer.role}</td>
                        <td>
                            <button type="button" class="btn" onclick="openRoleModal(${customer.userID})">Manage</button>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
        ...
        <div id="roleModal" class="modal">
            <div class="modal-content">
                ...
                <input type="hidden" name="currentRole" value="c" />
                <input type="hidden" name="redirectTo" value="AdminActionServlet" />

                <label><input type="radio" name="newRole" value="e" required> Edit Account</label><br>
                <label><input type="radio" name="newRole" value="s" required> Promote to Staff</label><br>
